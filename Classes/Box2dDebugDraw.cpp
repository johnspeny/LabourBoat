...
CcxBox2dDebugDraw::CcxBox2dDebugDraw(float ratio)
        : _ratio(ratio)
{
...
void CcxBox2dDebugDraw::DrawCircle(const b2Vec2& center, float radius, const b2Color& color)
{
...
void CcxBox2dDebugDraw::DrawSolidCircle(const b2Vec2& center, float radius, const b2Vec2& axis, const b2Color& color)
{
    const auto pos = Vec2((center.x * _ratio), (center.y * _ratio));
    // Draw filled circle
...
void CcxBox2dDebugDraw::DrawPoint(const b2Vec2& p, float size, const b2Color& color)
{
